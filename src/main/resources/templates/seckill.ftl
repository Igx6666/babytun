        ...
        <div class="layui-col-xs8" style="padding: 10px">
            <ul class="bb-info">
                ...
                <li style="color: darkgrey">
                    ...
                    <span>,库存只有<span style="font-size: 26px;color: orange;font-weight: bold">8</span>件啦,每人限购一件</span>
                </li>
                <li>
                ...
                <li>
                    <button class="layui-btn layui-btn-normal layui-bg-red" id="sub">立即抢购</button>
                </li>
            </ul>
        </div>
    </div>
...
<script>
    layui.use('carousel', function () {
        ...
        var $ = layui.$;
        $("#sub").click(function () {
            $.getJSON("/seckill/goods?id=1&userid=guxin", function (data) {
                alert(data.msg);
                ...
                swal({
                    ...
                    window.location.href = "/checkOrder/" + orderNo;
                })
            });
        });
    });
